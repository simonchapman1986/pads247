...
# class seo_parser
#
# class.seo_parser.php
#
# created by Simon Chapman - 04/059/2011

class seo_parser {
	
	function initiate($data,$country) {
		...
		$pagetitle = 'Luxury Villas '.$country.' | Luxury Holidays '.$country;
		$description = 'Luxury holidays in '.$country.' from QUINTESSENTIALLY Villas';
		...
		*/
		$keywords = 'luxury villas '.$country.', villas '.$country.', luxury villa '.$country.', exclusive villas '.$country;
